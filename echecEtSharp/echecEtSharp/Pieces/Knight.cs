    ...
    class Knight : Piece
    {
        ...
        public override void defineAvailableCases(Case c, List<Case> map)
        {
                    ...
                    for (int i = 1; i <= 8; i++)
                    {
                        ...
                        else if ((i == 3 && map.IndexOf(c) -  10 > 0 && map.IndexOf(c) - 10 < 64) && !isOnA(map.IndexOf(c)) && !isOnB(map.IndexOf(c)))
                        {
                        ...
                        else if ((i == 4 && map.IndexOf(c) - 6 > 0 && map.IndexOf(c) - 6 < 64) && !isOnG(map.IndexOf(c)) && !isOnH(map.IndexOf(c)))
                        {
                        ...
                        else if ((i == 5 && map.IndexOf(c) +15 > 0 && map.IndexOf(c) + 15 < 64) && !isOnA(map.IndexOf(c)))
                        {
                            tempC = map.ElementAt(map.IndexOf(c) + 15);
                                if (tempC.Piece == null || (IsWhite && !tempC.Piece.IsWhite))
                                {
                        ...
                        else if ((i == 6 && map.IndexOf(c) + 17 > 0 && map.IndexOf(c) + 17 < 64) && !isOnH(map.IndexOf(c)))
                        {
                            tempC = map.ElementAt(map.IndexOf(c) + 17);
                                if (tempC.Piece == null || (IsWhite && !tempC.Piece.IsWhite))
                                {
                        ...
                        else if ((i == 7 && map.IndexOf(c) + 6 > 0 && map.IndexOf(c) + 6 < 64) && !isOnA(map.IndexOf(c)) && !isOnB(map.IndexOf(c)))
                        {
                            tempC = map.ElementAt(map.IndexOf(c) + 6);
                                if (tempC.Piece == null || (IsWhite && !tempC.Piece.IsWhite))
                                {
                        ...
                        else if ((i == 8 && map.IndexOf(c) + 10 > 0 && map.IndexOf(c) + 10 < 64) && !isOnG(map.IndexOf(c)) && !isOnH(map.IndexOf(c)))
                        {
                            tempC = map.ElementAt(map.IndexOf(c) + 10);
                                if (tempC.Piece == null || (IsWhite && !tempC.Piece.IsWhite))
                                {
